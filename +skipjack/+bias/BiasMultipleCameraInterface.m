classdef BiasMultipleCameraInterface < handle
    ...
    methods
        function self = BiasMultipleCameraInterface()
            fprintf('Creating the BiasMultipleCameraInterface\n') ;
        end

        function delete(self)            
            fprintf('Deleting the BiasMultipleCameraInterface\n') ;
        ...
        function completingThenStartingSweep(self)
            self.completingSweep() ;
            self.startingSweep
        end
